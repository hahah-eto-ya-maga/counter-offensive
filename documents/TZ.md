...
Едиснтвенным источником опыта для Пользователя является участие в матчах против мобов. Формула расчета равна **(Базовый опыт + (Опыт/с * Время в игре) + Количество совершенных убийств)**. Количество опыта определяется следующими факторами:
...
1. Поле ввода логина.
2. Поле ввода пароля.
3. Кнопка "Пойти на Бахмут". При нажатии осуществляется переход на Главный экран.
...
3. Кнопка "Знаменосец". Если роль не занята, то при нажатии осуществляется переход на Игровую сцену знаменосца. В ином случае кнопка неактивна. 
...
### 5.2.1.3. Игровая сцена знаменосца
...
### 5.2.2.2. Магазин достиежний

На данный экран пользователь попадает при нажатии на кнопку "Витрина достижений".
На нем присутствуют следующие элементы:
1. *тут нужно придумать названия достижений, их цену и внешний вид*
2. Кнопка "Назад". При нажатии осуществляется переход на предыдущий экран.
...
**Генерал - важнейшая часть команды, им может быть только самый опытный боец, поэтому данная роль может быть перевыбрана игроком с наибольшим колчиеством опыта даже во время матча.**
* Обзор неограничен.
...
* Анимация движения: Важной частью дизайна будет плавное и пиксельно анимированное передвижение танков и пехотинцев по игровому полю. Будут созданы анимации движения танковых гусениц и шагов пехотинцев.
