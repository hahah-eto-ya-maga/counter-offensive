...
4. Кнопка "Назад". При нажатии осуществляется переход на Стартовый экран.

### 5.2. Главный экран

На данный экран пользователь попадает при нажатии на кнопку "Войти", после авторизации в приложении и при нажатии на кнопку "Попасть в списки военных", после регистрации в приложении. 
...
5. Поле с количеством выигранных игр Пользователя.
