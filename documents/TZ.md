...
В приложении существует несколько ролей, которые может выбрать Пользователь. Возможность выбора зависит от достигнутого в игре ранга.
...
10. Блок, внутри которого пронумерованы двухместные танки от одного до четырех, и показано количество свободных мест в каждом из них.
11. Кнопка "Трехместные танки". При нажатии осуществляется переход на экран "Экипаж трехместного танка".
12. Блок, внутри которого пронумерованы трехместные танки от одного до двух, и показано количество свободных мест в каждом из них.
...
11. Блок, внутри которого пронумерованы трехместные танки от одного до двух, и показано количество свободных мест в каждом из них.
12. Кнопка "Двухместные танки". При нажатии осуществляется переход на экран "Экипаж двухместного танка".
13. Блок, внутри которого пронумерованы двухместные танки от одного до четырех, и показано количество свободных мест в каждом из них.
